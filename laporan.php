            ...
            <div class="card-body">
                <form method="post" action="">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nama" name="nama" placeholder="Maya Dwi Apriyani" value="<?= isset($_POST['nama']) ? $_POST['nama'] : '' ?>">
                    </div>
                    <div class="mb-3">
                        <label for="nim" class="form-label">Masukkan NIM</label>
                        <input type="text" class="form-control" id="nim" name="nim" placeholder="202431159" value="<?= isset($_POST['nim']) ? $_POST['nim'] : '' ?>">
                    </div>
                    <div class="mb-3">
